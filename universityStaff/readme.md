...
classDiagram
    ...
    class Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee {
        <<abstract>>
        #String name
        #String department
        #String designation
        ...
        #double annualIncome
        +Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee(String name, String department, String designation, double monthlySalary)
        +calculateSalary()
    ...
    Staff <|.. Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee
    Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee <|-- Professor
    Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee <|-- AssistantProfessor
    Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee <|-- Clerk
```

## Key Features

1. **Staff Hierarchy**:
   - `Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee` abstract class implements `Staff` interface
...
3. **Design Patterns**:
   - Template Method Pattern (via `Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee` abstract class)
...
| `Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee` | Abstract base class with common attributes |
...
2. **DRY Principle**:
   - Common functionality in `Inheritance.intro.EmployeeSalarySlip.Inheritance.intro.Abstraction.Employee` base class
