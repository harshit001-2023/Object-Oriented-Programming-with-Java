...
public class ClassCastExceptionDemo {
    ...
    // Static method to demonstrate ClassCastException
    public static void handleClassCastException() {
        // Create an array of Objects with mixed types
    ...
    public static void main(String[] args) {
        // Call the method to demonstrate exception handling
